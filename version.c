...
const char * V_SLOCAL_REVISION="75+";
const char * V_SREVISION="e742216f7c44+";
const char * V_STAG="tip";
const char * V_BRANCH="default";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=true;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0xe742216f;
const uint16_t V_REVISION_1=0x7c44;
