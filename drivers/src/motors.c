...
#define MOTORS_GPIO_TIM_M3_4_PERIF  RCC_APB1Periph_TIM2
...
#define MOTORS_GPIO_M1            GPIO_Pin_2 // T2_CH3
#define MOTORS_GPIO_M2            GPIO_Pin_0 // T2_CH1
#define MOTORS_GPIO_M3            GPIO_Pin_1 // T2_CH2
...
void motorsInit()
{
  ...
  TIM_OC1Init(MOTORS_GPIO_TIM_M3_4, &TIM_OCInitStructure);
  TIM_OC1PreloadConfig(MOTORS_GPIO_TIM_M3_4, TIM_OCPreload_Enable);

  TIM_OC2Init(MOTORS_GPIO_TIM_M3_4, &TIM_OCInitStructure);
  TIM_OC2PreloadConfig(MOTORS_GPIO_TIM_M3_4, TIM_OCPreload_Enable);
...
void motorsSetRatio(int id, uint16_t ratio)
{
  switch(id)
  {
    ...
    case MOTOR_M2:
      ...
      break;
    case MOTOR_M3:
      TIM_SetCompare2(MOTORS_GPIO_TIM_M3_4, C_16_TO_BITS(ratio));
      break;
    case MOTOR_M4:
